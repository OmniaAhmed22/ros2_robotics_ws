...
class SimpleController(Node):
    ...
    def jointCallback(self, msg):
        ...
        delta_left = msg.position[0] - self.left_wheel_prev_pos_
        delta_right = msg.position[1] - self.right_wheel_prev_pos_
        ...
        omega_left = delta_left / dt_sec
        omega_right = delta_right / dt_sec

        # Calculate the linear and angular velocity
        linear = (self.wheel_radius_ * omega_right + self.wheel_radius_ * omega_left) / 2
        angular = (self.wheel_radius_ * omega_right - self.wheel_radius_ * omega_left) / self.wheel_separation_

        # Calculate the position increment
        d_s = (self.wheel_radius_ * delta_right + self.wheel_radius_ * delta_left) / 2
        d_theta = (self.wheel_radius_ * delta_right - self.wheel_radius_ * delta_left) / self.wheel_separation_
        self.theta_ += d_theta
...
def main():
    ...
    ideal_controller = SimpleController()
